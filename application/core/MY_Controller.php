...
//        
//    
//        if ($this->session->userdata('loginpermission') !== 'permitted') {
//            if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
//                if ($_POST['sign_in_username_email'] != 'art@mindworx.in') {
//                    $data['sign_in_username_email_error'] = lang('sign_in_username_email_does_not_exist');
//                }
//                if ($_POST['sign_in_password'] != 'Blossom@1#9') {
//                    $data['sign_in_error'] = lang('sign_in_combination_incorrect');
//                }
//                if ($_POST['sign_in_username_email'] == 'art@mindworx.in' && $_POST['sign_in_password'] == 'Blossom@1#9') {
//                    $this->session->set_userdata('loginpermission', 'permitted');
//                    //$this->authentication->sign_in(null, null, $login_for = 'P');
//                    redirect("welcome");
//                }
//            } else {
//                if ($this->uri->rsegment(1, '')=='permission') {
//                    return true;
//                } else {
...
//     * Redirect to 404 if Controller Class is present but the method is not there.
