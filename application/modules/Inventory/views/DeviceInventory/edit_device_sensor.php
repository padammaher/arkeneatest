                                    ...
                                    <?php if ($managed_dev_sen_Id_readonly == "sen") { ?>
                                        ...
                                        for ($i1 = 0; $i1 < count($temp_sensor_ids); $i1++) {
                                            ...
                                            <option value="<?php echo isset($temp_sensor_ids[$i1]) ? $temp_sensor_ids[$i1] : ''; ?>" 
                                                ...
                                                <?php echo isset($temp_sensor_number[$i1]) ? $temp_sensor_number[$i1] : 'Select Sensor'; ?></option>  

                                            <?php
                                        }
                                        foreach ($sensorid_list as $sensorid_list_data_2) {
                                            if (!in_array($sensorid_list_data_2['id'], $temp_sensor_ids)) {
                                                ?>
...
//                                        }
                                        ...
                                        foreach ($sensorid_list as $sensorid_list_data) {
                                            if (!in_array($sensorid_list_data['id'], $temp_sensor_ids)) {
                                                ?>
                                                <option value="<?php echo $sensorid_list_data['id']; ?>" <?php echo set_value('sensorid[]', $temp_sensor_ids) == $sensorid_list_data['id'] ? 'selected' : ''; ?> >  <?php echo $sensorid_list_data['sensor_no']; ?></option>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 control-label" style="text-align:left;">
                                ...
                                <label><?php
                                    ...
                                    ?> 
                                    <input type="checkbox" name="isactive" class="flat" <?php echo $isactive == "on" ? 'checked' : (isset($Edit_device_sensors_data['isactive']) && $Edit_device_sensors_data['isactive'] == "1") ? 'checked' : ''; ?>> Active
                                </label>
