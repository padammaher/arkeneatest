            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>Device_inventory_add">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control" name="devicedescription" rows="2" placeholder="Description.." style="resize: vertical;"><?php echo set_value('devicedescription'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">             
                            <?php
                            $setvalue = set_value('comm_type') ? set_value('comm_type') : '';
...
<?php } ?>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="gsmnumber" id="gsmnumber" class="form-control" placeholder="GSM Number" value="<?php echo set_value('gsmnumber'); ?>"  onkeyup="if (/\D/g.test(this.value))
                                        this.value = this.value.replace(/\D/g, '')" maxlength="11" minlength="10"  pattern="[0-9\s]*" maxlength="11" minlength="10" title="enter numbers only">
                        </div>
