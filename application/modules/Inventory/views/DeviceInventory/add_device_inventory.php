                                  ...
                                  <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                          ...
                                          <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <textarea class="form-control" name="devicedescription" rows="2" placeholder="Description.." style="resize: vertical;" required="required"></textarea>
                                                </div>
                                          </div>
                                          <div class="item form-group">
                                          ...
                                          <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                  <input type="text" name="gsmnumber" class="form-control" placeholder="GSM Number" required="required">
                                                </div>
                                          </div>
                                          <div class="item form-group">
