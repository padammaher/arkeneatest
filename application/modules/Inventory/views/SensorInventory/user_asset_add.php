...
<div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" class="form-control" placeholder="DG001">
              </div>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control">
                      <option value="">Saschin Naidoo</option>
                      <option value="10">Pankaj Shelke</option>
                      <option value="10">Paresh Kamat</option>
                      </select>
              </div>
              </div>						  
