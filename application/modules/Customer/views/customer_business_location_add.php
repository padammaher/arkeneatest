                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url() ?>Customer/add_business_location">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="state" required="required" id="State_id" onChange="getCity(this.value);">
                                    <option value="" <?php // echo set_value('state') ? 'selected' : '';   ?> >Select State</option> 
                                </select>
                            </div>
                        </div>  
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control"  name="city" id="City_id" required="required">
                                    <option value="" <?php // echo set_value('city') ? 'selected' : '';   ?>>Select City</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 control-label" style="text-align:left;">
                                <?php
                                echo $isactive = set_value('status');
                                $active = '';
                                if (!empty($isactive)) {
                                    $isactive == "on" ? 'checked' : '';
                                } else {
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="submit" id="customer_businees_location" class="btn btn-primary">Save</button>
