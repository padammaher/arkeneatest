        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content" id="">
                    <!--<div class="row">-->
                        <form class="form-inline form-label-left" action="<?php echo base_url() ?>asset_route" method="POST">
                        <div class="">                            
                            <label class="control-label col-md-1 col-sm-2 col-xs-6">Asset Name</label>
                            <div class="col-md-4">                
                                <input type="text" name="asset_name" value="<?php echo set_value('asset_name'); ?>" class="form-control" placeholder="Asset Name">
                            </div>
                        </div>
                        <div class="">
...
<!--end if not any address found then show current system location-->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <?php $userdetail=array();
           $cntl=1;$tsk_status='';
           $ukey['id']='11'; 
           $ukey['fse_name']='India';$k=1;
