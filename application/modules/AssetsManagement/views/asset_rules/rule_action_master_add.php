          ...
          <form class="form-horizontal form-label-left" name="add_asset" id="add_asset" method="post" action="<?php echo base_url();?>AssetsManagement/add_asset_rule_detail">
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="rule_no" id="rule_no" type="text" class="form-control static-text" placeholder="01">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="rule_name" id="rule_name" type="text" class="form-control" placeholder="Oil Pressure">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea class="form-control" name="rule_des" id="rule_des" rows="2" style="resize: vertical;" placeholder="Extreme Oil Pressure etc.">
                </textarea>
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="parameter" id="parameter" type="text" class="form-control" placeholder="Oil Pressure">
              </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="green_value" id="green_value" onfocusout="compare_rule_value();" type="text" class="form-control" placeholder="11">
              </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="orange_value" onfocusout="compare_rule_value();" id="orange_value" type="text" class="form-control" placeholder="20">
              </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="red_value"  onfocusout="compare_rule_value();" id="red_value" type="text" class="form-control" placeholder="19">
              </div>
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="xdisplay_inputx item form-group has-feedback">
                  <input type="text" name="wef_date" class="form-control has-feedback-left" id="single_cal1" placeholder="Wef Date" aria-describedby="inputSuccess2Status" data-inputmask="'mask': '99/99/9999'">
