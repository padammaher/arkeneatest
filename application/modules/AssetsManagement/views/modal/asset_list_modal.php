                ...
                <div class="modal-body">
                    <table class="table table-bordered">                      
                        <tbody>
                            ...
                            <tr>
                                <td class="lft-td">Start Date</td>
                                <td><?php echo (isset($list['startdate']))?$list['startdate']:''; ?></td>
                            </tr>
                            <tr>
                                <td class="lft-td">End Date</td>
                                <td><?php echo (isset($list['enddate']))?$list['enddate']:''; ?></td>
                            </tr>
                        </tbody>
                    </table>
