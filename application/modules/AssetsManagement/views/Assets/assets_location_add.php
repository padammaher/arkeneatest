            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left"  id="Add_Task" name="Add_Task" method="POST" action="<?php echo base_url(); ?>Assets_location_add">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="asset_lat" id="asset_lat" value="<?php echo set_value('asset_lat'); ?>"   class="form-control" placeholder="-26.107567"  value="<?php echo set_value('asset_lat'); ?>" required="required" onchange="CheckDecimallatitude(Add_Task.asset_lat)">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Longitude</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="asset_long" id="asset_long" value="<?php echo set_value('asset_long'); ?>"    class="form-control" placeholder="28.056702" required="required"  onchange="CheckDecimalLongitude(Add_Task.asset_long)">
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="asset_contactno" value="<?php echo set_value('asset_contactno'); ?>"   id="asset_contactno" class="form-control" placeholder="27 11 326 5900" required="required" onchange="Checkcontactno(Add_Task.asset_contactno)">
                        </div>
                    </div>
                    <div class="item form-group">
...
<!--                            <input type="text" name="asset_contactemail" class="form-control" placeholder="joy@bdv.co.za" data-validate-length-range="6" data-validate-words="2" required="required"  required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">-->
                            <input type="text" name="asset_contactemail" id="asset_contactemail" value="<?php echo set_value('asset_contactemail'); ?>" class="form-control" placeholder="joy@bdv.co.za"  required="required"  onchange="CheckEmailvalidation(Add_Task.asset_contactemail)">
                        </div>
