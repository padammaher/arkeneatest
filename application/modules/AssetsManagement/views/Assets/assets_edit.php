...
//                        var_dump($list);
    ...
    <?php foreach ($category_list as $category_list) {
        if ($list['asset_catid'] == $category_list['id']) {
    ...
    <?php if (form_error('Assetcategory')) { ?>
                        ...
                        <div class="item form-group">
                            ...
                            <?php foreach ($type_list as $typelistdata) {
                                if ($list['asset_typeid'] == $typelistdata['id']) {
        ...
        echo ($list['isactive']) == "1" ? 'checked' : '';
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <button type="submit" name="assets_edit_button" class="btn btn-primary">Update</button>
