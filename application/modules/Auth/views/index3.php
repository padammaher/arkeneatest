        ...
        <div class="x_panel tile">
            ...
            <div class="x_content">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <h4 class="gauge-head" id="echart_gaugehead"></h4>
                    <div id="echart_gauge" style="height:270px;"></div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <h4 class="gauge-head" id="echart_gauge1head"></h4>
                    <div id="echart_gauge1"  style="height:270px;"></div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <h4 class="gauge-head" id="echart_gauge2head"></h4>
                    <div id="echart_gauge2" style="height:270px;"></div>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
        ...
        if ($('#echart_gauge').length) {
            ...
            echartGauge.setOption({
                ...
                series: [{
                        ...
                        startAngle: 140,
                        endAngle: -140,
                        min: data[0]['min_value'],
                        max: data[0]['max_value'],
                        precision: 0,
                        splitNumber: 10,
                        axisLine: {
                            show: true,
        ...
        if ($('#echart_gauge1').length) {
            ...
            echartGauge1.setOption({
                ...
                series: [{
                        ...
                        startAngle: 140,
                        endAngle: -140,
                        min: data[1]['min_value'],
                        max: data[1]['max_value'],
                        precision: 0,
                        splitNumber: 10,
                        axisLine: {
                            show: true,
        ...
        if ($('#echart_gauge2').length) {
            ...
            echartGauge2.setOption({
                ...
                series: [{
                        ...
                        startAngle: 140,
                        endAngle: -140,
                        min: data[2]['min_value'],
                        max: data[2]['max_value'],
                        precision: 0,
                        splitNumber: 10,
                        axisLine: {
                            show: true,
        ...
        if ($('#echart_gauge3').length) {
            ...
            echartGauge3.setOption({
                ...
                series: [{
                        ...
                        startAngle: 140,
                        endAngle: -140,
                        min: data[3]['min_value'],
                        max: data[3]['max_value'],
                        precision: 0,
                        splitNumber: 10,
                        axisLine: {
                            show: true,
