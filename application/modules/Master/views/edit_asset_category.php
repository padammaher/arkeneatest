            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left" action="<?php echo base_url() ?>updateAssetCategory" method="POST">
                        <input type="hidden" name="edit_id" value="<?php echo $ast_cat_id; ?>">

                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Asset Category *</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" class="form-control" name="asset_category" value="<?php echo $result[0]['name']; ?>" required="required" pattern="[A-Za-z]*">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" rows="2" placeholder="Description.." name="asset_description" style="resize: vertical;"><?php echo $result[0]['description']; ?></textarea>
                            </div>
                        </div>
