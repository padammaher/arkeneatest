            ...
            <div class="pull-right">
                ...
                if (isset($permission) && !empty($permission)) {
                    if ($permission[0]->addpermission == 1) {
                        ?>
                        <a href="<?php echo base_url() ?>addUomTypeList" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add New</a>
                        <?php
                    } else {
                        ?>
...
//                                            if ($permission[0]->editpermission == 1 || $permission[0]->deletepermission == 1) {
                                        ...
                                        <td class="action">
                                            <form action="<?php echo base_url(); ?>updateUomTypeList" method="post" id="updateuomtype<?php echo $i; ?>">
                                                ...
                                                ?>
                                                <a title="Edit" class="<?php echo isset($edit_show) && $edit_show != 1 ? 'not-allowed' : 'edit'; ?>" id="<?php echo $i; ?>" style="padding-left: 5%;">  
                                                ...
                                                ?>
                                                <a title="Delete" class="<?php echo isset($delete_show) && $delete_show != 1 ? 'not-allowed' : 'delete'; ?>" id="<?php echo $i; ?>" style="padding-left: 5%;">
