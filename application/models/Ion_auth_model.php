...
//              exit;          
    ...
    public function update_client_detail($additional_data, $id) {
        $user_id = $this->session->userdata('user_id');
        ...
        $this->db->where('id', $id);
        $this->db->update('users', $Add_user_data);
              ...
              <tr>
                <td>
                  <table align="center" cellpadding="0" cellspacing="0" class="page-center" style="text-align: left; padding-bottom: 88px; width: 100%; padding-left: 120px; padding-right: 120px;">
                    <tbody>
                     <tr>
                        <td colspan="2" style="padding-top: 30px; padding-bottom: 30px; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; color: #73879C !important; font-family: \'Postmates Std\', \'Helvetica\', -apple-system, BlinkMacSystemFont, \'Segoe UI\', \'Roboto\', \'Oxygen\', \'Ubuntu\', \'Cantarell\', \'Fira Sans\', \'Droid Sans\', \'Helvetica Neue\', sans-serif; font-size: 35px; font-smoothing: always; font-style: normal; font-weight: 600; letter-spacing: -2.6px; line-height: 35px; mso-line-height-rule: exactly; text-decoration: none; text-align: center">Reset your password
                     </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>
                          <a data-click-track-id="37" href="'.base_url().'Auth/reset_password/'.$key.'" style="margin-top: 36px; -ms-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; color: #ffffff; font-family: \'Postmates Std\', \'Helvetica\', -apple-system, BlinkMacSystemFont, \'Segoe UI\', \'Roboto\', \'Oxygen\', \'Ubuntu\', \'Cantarell\', \'Fira Sans\', \'Droid Sans\', \'Helvetica Neue\', sans-serif; font-size: 12px; font-smoothing: always; font-style: normal; font-weight: 600; letter-spacing: 0.7px; line-height: 48px; mso-line-height-rule: exactly; text-decoration: none; vertical-align: top; width: 220px; background-color: #1ABB9C; border-radius: 28px; display: block; text-align: center; text-transform: uppercase; float: none; margin: 22px auto" target="_blank">
                            Reset Password
                          </a>
                        </td>
                      </tr>
