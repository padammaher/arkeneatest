/**
 * @Package: Pro Admin HTML Theme
 * @Since: Pro 1.0
 * This file is part of Pro Admin Theme HTML package.
 */
...
jQuery(function ($) {
        ...
        $('.page-chatapi .user-row').on('click', function () {
            ...
            if ($(this).hasClass("active")) {
                ...
                if ($(".chatapi-windows #user-window" + id).length) {
                    ...
                    msg += chatformat_msg('Yes! Pro Admin Theme ;)', 'sent', 'You');
    ...
    ULTRA_SETTINGS.dataTablesInit = function () {
        ...
        if ($.isFunction($.fn.dataTable)) {
            ...
            $("#dt-view-document,#dt-view-document1,#dt-activate-associate1,#dt-activate-associate ,#example-1, #dt-leave-allocation,#table_id,#dt-associate-of-months,#dt-approve-opening").dataTable({
                responsive: true,
                buttons: [
                    'excel'
                ],
            ...
            /*Attendance Biomatric*/
            $("#biomatric_month,#biomatric-records,#biomatic-month-report,#show_biomatric_month").dataTable({
                responsive: true,
                aLengthMenu: [
                    [5, 10, 25, 50, 100, -1],
                    [5, 10, 25, 50, 100, "All"]
            ...
            /* Attendance Punches*/
            $("#punch-records,#month-punch-records,#punch-month-report,#show_punch_month").dataTable({
                responsive: true,
                aLengthMenu: [
                    [5, 10, 25, 50, 100, -1],
                    [5, 10, 25, 50, 100, "All"]
            ...
            /*Timesheet*/
            $("#timesheet-approval,#team-timesheet-approval").dataTable({
                responsive: true,
                aLengthMenu: [
                    [5, 10, 25, 50, 100, -1],
                    [5, 10, 25, 50, 100, "All"]
            ...
            /*client*/
            $("#client-list,#project-list").dataTable({
                responsive: true,
                aLengthMenu: [
                    [5, 10, 25, 50, 100, -1],
                    [5, 10, 25, 50, 100, "All"]
    ...
    /*slim scroll bar class and id here normal div and modal div*/
    $(".user-modal-slim").slimscroll({
        width: '100%',
        height: '465px'
    }); /* modal div here*/

    $(".user-back-slim").slimscroll({
        width: '100%',
        height: '380px'
    }); /*backend div here*/
